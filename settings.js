...
//——————————[ Bot Settings ]——————————//
global.botname = 'darknote V1.0'
global.versi = '1.0.0'
global.foot = '© darknote V1.0'
global.idSaluran = ""
...
global.mesg = {
  ...
  gc: "*[ darknote System ]* This feature is only for groups",
  own: "*[ darknote System ]* This feature is only for the owner",
  adm: "*[ darknote System ]* This feature is only for admins",
...
fs.watchFile(__filename, () => {
  ...
  console.log(chalk.green.bold("New Update: darknote V1.0 Settings"));
